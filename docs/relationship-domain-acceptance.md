...
## Phase 2 — release acceptance audit

`docs/relationship-release-audit.md` is the P33 release-control record. It
must distinguish static source evidence from full runtime verification and may
not mark release acceptance complete until the required CI-equivalent checks,
browser route/accessibility review, and screenshot review have been recorded.
