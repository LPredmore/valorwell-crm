      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Shared authoring surface for direct, campaign, and newsletter content. This Pass 4 route does not save or send email.
          </p>
        </div>
        ...
        <CardContent className="flex flex-wrap items-end gap-5 p-4">
          <div className="min-w-[220px] space-y-1.5">
            ...
            <Select
              value={scope}
              onValueChange={(value) => {
                setScope(value as EmailContentScope);
                setLastExport(null);
              }}
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="relationship">Relationship outreach</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <p className="ml-auto max-w-xl text-xs text-muted-foreground">
            Changing scope remounts the composer so client and relationship variables never share an active editor document.
          </p>
        </CardContent>
      </Card>
