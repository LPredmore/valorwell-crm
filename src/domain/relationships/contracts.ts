...
export type RelationshipOpportunity = AuditMetadata & { id: string; organizationId: string; primaryContactId?: string; status: OpportunityStatus; ownerId?: string; causeArea?: string; veteranPriority?: boolean; qualification: Record<string, string | boolean | number | undefined>; reviewStatus?: string; riskFlags?: string[]; nextAction?: string; nextActionDueAt?: string };
